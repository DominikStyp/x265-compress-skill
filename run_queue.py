...
split into queue_modules:
    ...
    completion -- _record_completion + _verify_move_outcome + _same_dir
                  (state-sidecar persistence + done_dir move verification).
...
from queue_modules.completion import (
    _record_completion,
    _same_dir,  # noqa: F401 — re-exported so tests' run_queue._same_dir resolves
    _verify_move_outcome,  # noqa: F401 — re-exported for test references
)
